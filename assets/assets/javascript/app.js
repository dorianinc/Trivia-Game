...
function startGame()
{
    ...
    gameHTML = "<p class = 'text-center question'> " + currentQuestion.text[0] + "</br>" + currentQuestion.text[1] + "</p>" + "<p class = 'text-center options'>" + "A: " + currentQuestion.options[0] + "</p>" + "<p class = 'text-center options'>" + "B: " + currentQuestion.options[1] + "</p>" + "<p class = 'text-center options'>" + "C: " + currentQuestion.options[2] + "</p>" + "<p class = 'text-center options'>" + "D: " + currentQuestion.options[3] + "</p>";
...
function checkWinLose()
{
    ...
    else if(selectedOption !== currentQuestion.answer)
    {
        ...
        gameHTML = "<p class = 'text-center options'>" + "Thats Incorrect" + "</p>" + loseImage;
        $('.mainContent').html(gameHTML);
        inCorrect++;
        currentQuestionNumber++;
        setTimeout(next, 5000);
